class City_Weather {
  ...
  final List<Listt> weather_lisst;
  final City city;
  ...
  factory City_Weather.fromJson(Map<String, dynamic> json) {
    return City_Weather(
        ...
        cnt: json['cnt'] as int,
        weather_lisst: (json['list'] as List<dynamic>)
  ...
  @override
  String toString() {
    return 'City_Weather{cod: $cod, message: $message, cnt: $cnt, weather_lisst: $weather_lisst, city: $city}';
  }
}
